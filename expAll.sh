...
python main.py -model finetune -init 6 -incre 1  -p benchmark -d 0 1 -dt True --debug &
python main.py -model finetune -init 6 -incre 1  -p benchmark -d 0 1 --debug &
python main.py -model finetune -init 6 -incre 1  -p benchmark -d 0 1 -dt True -so dcl --debug &
wait      # 等待所有后台任务结束
